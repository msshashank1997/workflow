...
try {
    az deployment group create --resource-group $rgname --template-file 'D:\a\workflow\workflow\powershell_scripts\main.bicep' --parameters 'D:\a\workflow\workflow\powershell_scripts\parameters.json'
}
catch {
